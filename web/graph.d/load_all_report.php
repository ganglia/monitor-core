...
function graph_load_all_report( &$rrdtool_graph ) 
{
    global $context,
           $cpu_num_color,
           $cpu_user_color,
    ...
    $series = "DEF:'load_one'='${rrd_dir}/load_one.rrd':'sum':AVERAGE "
        ."DEF:'load_five'='${rrd_dir}/load_five.rrd':'sum':AVERAGE "
        ."DEF:'load_fifteen'='${rrd_dir}/load_fifteen.rrd':'sum':AVERAGE ";

    $series .="LINE2:'load_one'#$load_one_color:'1-min\\g' ";
    $series .="LINE2:'load_five'#$cpu_num_color:'5-min\\g' ";
    $series .="LINE2:'load_fifteen'#$proc_run_color:'15-min\\g' "
    ."CDEF:na=load_one,UN,0,load_one,IF "
    ."CDEF:nb=load_five,UN,0,load_five,IF "
    ."CDEF:nc=load_fifteen,UN,0,load_fifteen,IF ";
