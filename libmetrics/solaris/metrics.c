 ...
 *
 *
gcc -m64 -I.. -I../lib -I../lib/dnet -g -O2 -Wall -DHAVE_CONFIG_H -D__EXTENSIONS__ -D_POSIX_C_SOURCE=199506L \ 
   -DHAVE_STRERROR -DSTAND_ALONE_TEST  -o gmo.tst machine.c ../lib/.libs/libganglia.a \ 
   ../lib/libgetopthelper.a -ldl -lkstat -lresolv -lnsl -lsocket -lpthread
 *
 */
