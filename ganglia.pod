...
shows what platforms the metric are supported on.  

  Metric Name    Description                             Platforms
  -----------------------------------------------------------------------
  boottime      System boot timestamp                    l   
  bread_sec
  bwrite_sec
  ...
  cpu_wait
  cpu_wio
  disk_free     Total free disk space                    l
  disk_total    Total available disk space               l
  ...
  lwrite_sec
  machine_type
  mem_buffers   Amount of buffered memory                l
  mem_cached    Amount of cached memory                  l
  mem_free      Amount of available memory               l
  mem_shared    Amount of shared memory                  l
  mem_total     Amount of available memory               l,f
  mtu           Network maximum transmission unit        l
  os_name       Operating system name                    l
  os_release    Operating system release (version)       l
