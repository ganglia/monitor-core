...
%  {metric_bread_sec,    "bread_sec",     90, GANGLIA_VALUE_FLOAT,          "1/sec",      "both",  "%.2f",UDP_HEADER_SIZE+8},
%  {metric_bwrite_sec,   "bwrite_sec",    90, GANGLIA_VALUE_FLOAT,          "1/sec",      "both",  "%.2f",UDP_HEADER_SIZE+8},
%  {metric_lread_sec,    "lread_sec",     90, GANGLIA_VALUE_FLOAT,          "1/sec",      "both",  "%.2f",UDP_HEADER_SIZE+8},
%  {metric_lwrite_sec,   "lwrite_sec",    90, GANGLIA_VALUE_FLOAT,          "1/sec",      "both",  "%.2f",UDP_HEADER_SIZE+8},
...
%  {metric_phread_sec,   "phread_sec",    90, GANGLIA_VALUE_FLOAT,          "1/sec",      "both",  "%.2f",UDP_HEADER_SIZE+8},
%  {metric_phwrite_sec,  "phwrite_sec",   90, GANGLIA_VALUE_FLOAT,          "1/sec",      "both",  "%.2f",UDP_HEADER_SIZE+8},
